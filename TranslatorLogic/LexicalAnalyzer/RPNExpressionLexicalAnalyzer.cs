...
{
    public class RPNExpressionLexicalAnalyzer : ILexicalAnalyzer
    {
        ...
        private string _lastVariableType = "int";

        private const string NEW_LINE_SYMBOL = "¶";

        public RPNExpressionLexicalAnalyzer(ILexemeService lexemeService
